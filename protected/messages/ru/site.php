...
return array(
	...
	'2checkout hash' => 'если подключается платежная система 2checkout - уникальный идентификатор; хэш 2checkout',
	...
	'Personal cabinet (authorization; for any type of user)' => 'Вставьте эти ссылки у себя на сайт',
	'Quick registration (or, also, registration of the customer)' => 'Вставьте эти ссылки у себя на сайт',
	'Registering the company as WEB MASTER (Partner, leading clients)' => 'Регистрацкомпаниия как WEB MASTER (Партнер, приводящий клиентов)',
	...
	'Tips for managers' => 'Подсказки для менеджеров',
	...
	'Message for a manager that the agreement was not accepted by the customer' => 'Сообщение для менеджера, что соглашение не было принято заказчиком',
	...
	'Date of informing (manager)' => 'Дата информирования (менеджер)',
