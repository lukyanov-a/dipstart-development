...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<label for="Templates_title" class="required"><?=Yii::t('site','Letter subject')?> <span class="required">*</span></label>
		<?php echo $form->textField($model,'title',array('size'=>60,'maxlength'=>255)); ?>
		<?php echo $form->error($model,'title'); ?>
	</div>

	<div class="row">
		<label for="Templates_text" class="required"><?=Yii::t('site','message')?> <span class="required">*</span></label>
