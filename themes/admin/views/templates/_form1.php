...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<label for="Templates_title" class="required"><?=Yii::t('site','The category of the question (for example, "questions on payment" or "questions on the schedule of work", etc.)')?> <span class="required">*</span></label>
