...
<?php echo CHtml::beginForm(); ?>
	...
	<p class="note form-item"><?php echo UserModule::t('Fields with <span class="required">*</span> are required.'); ?></p>

	<?php echo CHtml::errorSummary($model); ?>
	
	<div class="varname form-item">
	...
	<div class="field_type form-item">
	...
	<div class="field_size form-item">
	...
	<!--<div class="field_size_min form-item">
	...
	<div class="error_message form-item">
	...
	<!--<div class="other_validator form-item">
	...
	<div class="widgetparams form-item">
	...
	<div class="paymentProps form-item">
